    ...
    <form class="row" action="/update/{{$valor_edit->id}}" method="POST" enctype="multipart/form-data">    
        ...
        <div class="col-md-6 m-auto row" style="border: 1px solid red; border-radius:15px; padding: 10px">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" style="width: 400px" id="nome" name="nome" aria-describedby="emailHelp" value="{{ $valor_edit->clube_nome}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cidade" style="width: 400px" name="cidade" aria-describedby="emailHelp" value="{{ $valor_edit->clube_cidade }}">
               
            </div>

            <div class="mb-3">
                <label for="image">Estado</label>
                <input type="text" class="form-control" id="estado" style="width: 400px" name="estado" aria-describedby="emailHelp" value="{{ $valor_edit->clube_estado }}">
